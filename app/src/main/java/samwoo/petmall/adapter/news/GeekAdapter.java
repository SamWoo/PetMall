...
public class GeekAdapter extends BaseAdapter {
    private Context mContext;
    private List<GeekEntity.ResultsBean> mList;

    public GeekAdapter(Context context, List<GeekEntity.ResultsBean> list) {
...
//        Glide.with(mContext).load(mList.get(i).getImages()).centerCrop().into(holder.mItemImage);
        holder.mItemTitle.setText(mList.get(i).getDesc());
        holder.mItemAuthor.setText(mList.get(i).getWho());
        return view;
